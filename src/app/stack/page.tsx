...
export default function Page() {
  return (
    <>
      <JsonLd route={"/stack"} title={"My stack — hallelx2 labs"} description={"Nine stacks and the shipped thing each one is answerable for — Bun, Go, Java 21 with Spring AI, Next.js, Expo, Cloudflare Durable Objects, Python, Postgres and the agent layer — read out of the repositories they name."} />
      <StackView />
    </>
  );
}
