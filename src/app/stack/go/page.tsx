...
export default function Page() {
  return (
    <>
      <JsonLd route={"/stack/go"} title={"Go — hallelx2 labs"} description={"Go across the Vectorless retrieval engine, pdfgrab and LLMGate — why a library other people compile into their own programs is a different engineering problem from a service you run yourself."} />
      <StackGoView />
    </>
  );
}
