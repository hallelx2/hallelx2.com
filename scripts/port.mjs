...
const PAGES = [
  ...
  { src: "hallelx2-activity.html", route: "activity", view: "Activity", slug: "activity", cta: "Get in touch", active: "activity" },
  ...
  { src: "stack-bun.html", route: "stack/bun", view: "StackBun", slug: "stack-bun", cta: "Get in touch", active: null },
  { src: "stack-go.html", route: "stack/go", view: "StackGo", slug: "stack-go", cta: "Get in touch", active: null },
  { src: "stack-java.html", route: "stack/java", view: "StackJava", slug: "stack-java", cta: "Get in touch", active: null },
  { src: "stack-next.html", route: "stack/next", view: "StackNext", slug: "stack-next", cta: "Get in touch", active: null },
  { src: "stack-expo.html", route: "stack/expo", view: "StackExpo", slug: "stack-expo", cta: "Get in touch", active: null },
  { src: "stack-cloudflare.html", route: "stack/cloudflare", view: "StackCloudflare", slug: "stack-cloudflare", cta: "Get in touch", active: null },
  { src: "stack-python.html", route: "stack/python", view: "StackPython", slug: "stack-python", cta: "Get in touch", active: null },
  { src: "stack-postgres.html", route: "stack/postgres", view: "StackPostgres", slug: "stack-postgres", cta: "Get in touch", active: null },
  { src: "stack-agents.html", route: "stack/agents", view: "StackAgents", slug: "stack-agents", cta: "Get in touch", active: null },
  { src: "hallelx2-writing.html", route: "writing", view: "Writing", slug: "writing", cta: "Get in touch", active: "writing" },
...
const URL_MAP = new Map([
  ...
  ["stack-bun.html", "/stack/bun"],
  ["stack-go.html", "/stack/go"],
  ["stack-java.html", "/stack/java"],
  ["stack-next.html", "/stack/next"],
  ["stack-expo.html", "/stack/expo"],
  ["stack-cloudflare.html", "/stack/cloudflare"],
  ["stack-python.html", "/stack/python"],
  ["stack-postgres.html", "/stack/postgres"],
  ["stack-agents.html", "/stack/agents"],
  ["hallelx2-writing.html", "/writing"],
...
// variance point: Activity link takes aria-current on /activity
// variance point: Writing link takes aria-current on /writing
navJsx = navJsx.replace(
  `<a className="navlink" href="/writing">{"Writing"}</a>`,
  `<a className="navlink" href="/writing" aria-current={active === "writing" ? "page" : undefined}>{"Writing"}</a>`,
);
navJsx = navJsx.replace(
  `<a className="navlink" href="/activity">{"Activity"}</a>`,
  `<a className="navlink" href="/activity" aria-current={active === "activity" ? "page" : undefined}>{"Activity"}</a>`,
);
navJsx = navJsx.replace(
...
if (!navJsx.includes("{cta}") || !navJsx.includes('active === "about"') ||
    !navJsx.includes('active === "training"') || !navJsx.includes('active === "products"') ||
    !navJsx.includes('active === "libraries"') || !navJsx.includes('active === "activity"') ||
    !navJsx.includes('active === "writing"'))
...
export default function SiteNav({
  ...
  active?: "about" | "training" | "products" | "libraries" | "activity" | "writing" | null;
  cta?: string;
}) {
  return (
